...
type ButtonProps = (
  | { color?: keyof typeof styles.colors; outline?: never; plain?: never; flexGrow?: boolean }
  | { color?: never; outline: true; plain?: never; flexGrow?: boolean}
  | { color?: never; outline?: never; plain: true; flexGrow?: boolean}
) & { children: React.ReactNode } & (HeadlessButtonProps | React.ComponentPropsWithoutRef<typeof Link>)

export const Button = React.forwardRef(function Button(
  { color, outline, plain, flexGrow, className, children, ...props }: ButtonProps,
